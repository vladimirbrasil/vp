...
Por exemplo: se for possível conseguir exame residuográfico positivo em 80% dos casos em que foi utilizada arma de fogo, a elucidação de homicídios será de 40%.
